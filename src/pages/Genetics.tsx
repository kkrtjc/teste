          ...
          <div className="p-4 sm:p-6 border-b border-theme-border flex flex-col sm:flex-row justify-between gap-4 shrink-0 bg-theme-surface/50">
            <div className="flex items-center gap-3 w-full sm:w-auto">
              <div className="relative flex-1 sm:flex-none">
                ...
                <input type="text" placeholder="Buscar anilha ou nome..." className="w-full bg-theme-surface border border-theme-border rounded-lg py-2 pl-9 pr-4 text-sm text-white focus:border-theme-primary outline-none" />
              </div>
